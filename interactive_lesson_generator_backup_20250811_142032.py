...
def create_interactive_ai_lesson():
    ...
    # Enhanced Final Completion Certificate
    if all([st.session_state.activity1_completed, st.session_state.activity2_completed, 
        ...
        # Enhanced Certificate with modern design
        st.markdown(f"""
        <div style="
        ...
        ">
            ...
            ">
                ...
                <p style="
                    ...
                    margin-bottom: 15px;
                    line-height: 1.6;
                ">This certifies that you have successfully completed</p>
                ...
                <h3 style="
                    ...
                    margin: 20px 0;
                    text-shadow: 1px 1px 2px rgba(0,0,0,0.1);
                ">✨ The Complete Interactive AI Adventure! ✨</h3>
            </div>
            ...
            ">
                ...
                ">
                    ...
                    <h4 style="margin: 10px 0;">AI Detective</h4>
                    <p style="font-size: 1.5em; font-weight: bold;">{detective_score}/3</p>
                </div>
                ...
                ">
                    ...
                    <h4 style="margin: 10px 0;">Quiz Master</h4>
                    <p style="font-size: 1.5em; font-weight: bold;">{quiz_score}/3</p>
                </div>
                ...
                ">
                    <div style="font-size: 2.5em;">🎨</div>
                    <h4 style="margin: 10px 0;">AI Artist</h4>
                    <p style="font-size: 1.5em; font-weight: bold;">{art_creations}</p>
                </div>
                ...
                ">
                    <div style="font-size: 2.5em;">🧠</div>
                    <h4 style="margin: 10px 0;">Pattern Trainer</h4>
                    <p style="font-size: 1.5em; font-weight: bold;">3/3</p>
                </div>
                ...
                ">
                    <div style="font-size: 2.5em;">🤖</div>
                    <h4 style="margin: 10px 0;">AI Friend Creator</h4>
                    <p style="font-size: 1.5em; font-weight: bold;">1</p>
                </div>
            </div>
            ...
            ">
                <h2 style="
                    ...
                    margin-bottom: 15px;
                    text-shadow: 1px 1px 2px rgba(0,0,0,0.1);
                ">🚀 You are now an official AI Explorer! 🚀</h2>
                ...
                <p style="
                    ...
                    margin-top: 20px;
                ">
                    🗓️ Completed on {datetime.now().strftime("%B %d, %Y")} at {datetime.now().strftime("%H:%M")}
                </p>
        ...
        with col2:
            ...
            with col_a:
                if st.button("🔄 New Adventure", type="primary", key="new_adventure"):
                    # Reset all progress
...
⭐ Keep exploring and learning! ⭐
        ...
        <div style="
            ...
            box-shadow: 0 8px 16px rgba(0,0,0,0.1);
        ">
            <h3 style="color: #2d3436; margin-bottom: 15px;">🎉 Fun Facts About Your Journey!</h3>
            <p style="color: #2d3436; font-size: 1.1em; margin: 10px 0;">
                🤖 You learned what AI is and how it works!<br>
                🎨 You created your own AI friend and artwork!<br>
                🧠 You trained an AI to recognize patterns!<br>
                🎯 You're now ready for more AI adventures!
            </p>
        </div>
        """, unsafe_allow_html=True)
