  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        let errorMessage = "Pošiljanje sporočila ni uspelo"
        try {
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold mb-4 text-gray-900">Kontaktirajte nas</h1>
            <p className="text-lg text-gray-600">
              Radi bi slišali od vas! Pošljite nam sporočilo in odgovorili bomo v najkrajšem možnem času.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <h3 className="font-bold text-lg mb-2">E-poštna podpora</h3>
              <p className="text-gray-700 text-sm mb-2">Za splošna vprašanja in podporo</p>
            ...
            <div className="bg-purple-50 p-6 rounded-lg">
              ...
              <h3 className="font-bold text-lg mb-2">Odzivni čas</h3>
              <p className="text-gray-700 text-sm mb-2">Običajno odgovorimo v roku</p>
              <p className="font-semibold text-gray-900">24–48 ur</p>
              <p className="text-xs text-gray-600 mt-2">(Premium naročniki imajo prednostno podporo)</p>
            </div>
          </div>
          ...
          {isSubmitted ? (
            <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
              <div className="text-5xl mb-4">✅</div>
              <h3 className="text-2xl font-bold text-green-900 mb-2">Sporočilo poslano!</h3>
              <p className="text-green-700">Hvala, ker ste nas kontaktirali. Kmalu se vam bomo oglasili.</p>
            </div>
          ) : (
          ...
          <div className="mt-12 pt-8 border-t">
            <h3 className="font-bold text-lg mb-4 text-center">Drugi načini za stik z nami</h3>
            <div className="grid md:grid-cols-3 gap-4 text-center text-sm">
              <div>
                <p className="font-semibold mb-1">Splošna vprašanja</p>
                <a href="mailto:support@kids-learning-ai.com" className="text-blue-600 hover:underline">
                  support@kids-learning-ai.com
                </a>
              </div>
              <div>
                <p className="font-semibold mb-1">Vprašanja o zasebnosti</p>
                <a href="mailto:privacy@kids-learning-ai.com" className="text-blue-600 hover:underline">
                  privacy@kids-learning-ai.com
                </a>
              </div>
              <div>
                <p className="font-semibold mb-1">Pravne zadeve</p>
