      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/varstvo-otrok" className="text-gray-600 hover:text-gray-900">
                  Varstvo otrok
                </Link>
              </li>
              <li>
          ...
          <div>
            <h4 className="font-semibold mb-3 text-gray-900">Poveži se</h4>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/contact" className="text-gray-600 hover:text-gray-900">
        ...
        <div className="border-t pt-6 text-center text-sm text-gray-600">
          <p>&copy; {new Date().getFullYear()} Kids Learning AI Platforma. Vse pravice pridržane.</p>
        </div>
      </div>
    </footer>
  )
